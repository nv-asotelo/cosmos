...
| Explainable mixed-SKU palletizer | Reasoner + Generator | Cosmos3-Nano and Cosmos3-Super Diffusers validation for palletizing-scene artifacts, plus a Cosmos3-Nano Reasoner full-stack smoke path with the Doosan Robotics Isaac Sim/cuRobo app. | [Guide](cookbooks/cosmos3/explainable-palletizer/README.md) | N/A |
