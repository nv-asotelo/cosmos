...
| Explainable mixed-SKU palletizer | Reasoner | Public headless Cosmos3 Reasoner workflow: send box images and optional pallet metadata to a standalone `/v1/chat/completions` endpoint on port 8200, then save reasoning and structured action artifacts. | [Guide](cookbooks/cosmos3/explainable-palletizer/README.md) | N/A |
